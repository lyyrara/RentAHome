...
* The original package name 'com.rentahome.' is invalid and this project uses 'com.rentahome' instead.
...
* [Spring Boot Maven Plugin Reference Guide](https://docs.spring.io/spring-boot/3.3.2-SNAPSHOT/maven-plugin)
* [Create an OCI image](https://docs.spring.io/spring-boot/3.3.2-SNAPSHOT/maven-plugin/build-image.html)
